...
```text
fixdecoder v1.0.0 (branch:main, commit:d994611)
...
Usage: fixdecoder [--xml=FILE] [--fix=VERSION] [--info] [--message[=MSG]]
       ...
       [--trailer] [-h|--help] [--version] [file1.log file2.log ...]
...
Options:
  ...
  --message[=MSG]
      Message name or MsgType; omit the value to list all messages.
  --component[=NAME]
      Component to display; omit the value to list all components.
  --tag[=TAG]
      Tag number to display details for; omit the value to list all tags.
  --column
