...
```text
fixdecoder v1.0.0 (branch:main, commit:51632ff)
...
Usage: fixdecoder [--xml=FILE] [--fix=VERSION] [--info] [--message[=MSG]]
       ...
       [--trailer] [--help | -h] [--version] [file1.log file2.log ...]

Flags:
  --xml=FILE
    Path to alternative FIX XML file
  --fix=VERSION
    FIX version to use (40,41,42,43,44,50,50SP1,50SP2,T11)
  --info
    Show XML schema summary
  --message[=MSG]
    Message name or MsgType; omit MSG to list all messages
  --component[=NAME]
    Component to display; omit NAME to list all components
  --tag[=TAG]
    Tag number to display details for; omit TAG to list all tags
  --column
